...
const Profile = ({ data }: IProps) => {
  ...
  return (
    <div className="w-full ">
      <div className="flex items-center gap-6 md:gap-10 mb-4 bg-wgite w-full">
        ...
        <div className="hidden xl:block">
          <p className="flex gap-1 md:text-2xl tracking-wider items-center font-bold text-primary lowercase">
